...
export const en: Messages = {
  ...
  settings: {
    ...
    sshHosts: {
      ...
      desc: "Enroll plain-Linux hosts over your existing SSH access (key auth only — no passwords, no agents). Probe discovers engine binaries; attaching a workspace routes its sends through the SSH transport.",
      host: "Host",
      user: "User",
      port: "Port",
      probeAdd: "Probe & add host",
      remove: "Remove",
      none: "no engines found",
      unprobed: "not probed",
      attachTitle: "Attach a workspace",
      attachHost: "Host",
      chooseHost: "Choose a host…",
      localPath: "Local workspace label path",
      remotePath: "Remote path",
      attach: "Attach workspace",
      fromConfig: "From your SSH config",
      addSelected: "Add selected ({{count}})",
      manualTitle: "Add manually",
      invalid: "Enter a host, user, and a port 1-65535.",
      invalidAttach: "Pick a host and fill both paths.",
      unreachable: "Host unreachable.",
      added: "Host {{host}} added.",
      addedSelected: "Added {{count}} host(s).",
      attached: "Workspace {{path}} attached (engines: {{engines}}).",
    },
    proxyDesc:
